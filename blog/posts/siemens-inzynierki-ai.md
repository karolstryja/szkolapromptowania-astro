...
Bo inżynieria się zmieniła. Dziś inżynier pracuje z ogromnymi ilościami danych, analizuje setki stron dokumentacji, optymalizuje procesy i generuje raporty. Kto tego nie robi z pomocą AI, zostaje w tyle.

> Inżynier bez umiejętności AI to jak księgowa zamykająca rok na liczydle. Technicznie możliwe — praktycznie bez sensu.

Dlatego Siemens zaprosił nas — Marcina Sawickiego i mnie — żeby przeprowadzić warsztaty z prompt engineeringu dla 30 ambitnych studentek.
...
images/blog/siemens/workshop-4.jpg | Ćwiczenia z frameworków COSTAR i Chain of Thought
images/blog/siemens/workshop-5.jpg | Prezentacja wyników
:::

## Od Kuby Wojewódzkiego do analizy SWOT

Warsztaty zaczęliśmy od czegoś, co nie wyglądało na "techniczne szkolenie". Poprosiliśmy AI o napisanie tekstu w stylu Kuby Wojewódzkiego. Potem o analizę Królewny Śnieżki w stylu Harvard Business Review.
...
Te 30 studentek już zna odpowiedź.
